...
export default {
  ...
  computed: {
    fetchDataMethod() {
      ...
      return isMine ? this.$API_CUSTOMER.getSelfCustomerFans : (isLogin ? this.$API_CUSTOMER.getCustomerFans : this.$API_USER.getFans)
    }
  },
  methods: {
    ...
    async fetchData({
      ...
      const realValue = (Array.isArray(data) ? data : data.fans || [])
